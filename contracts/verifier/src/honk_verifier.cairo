use super::honk_verifier_circuits::{
    ...
    run_GRUMPKIN_HONK_SUMCHECK_SIZE_17_PUB_24_circuit,
};
...
mod UltraStarknetHonkVerifier {
    ...
    use super::{
        ...
        run_GRUMPKIN_HONK_SUMCHECK_SIZE_17_PUB_24_circuit, vk,
    };
    ...
    impl IUltraStarknetHonkVerifier of super::IUltraStarknetHonkVerifier<ContractState> {
        fn verify_ultra_starknet_honk_proof(
            ...
            let (sum_check_rlc, honk_check) = run_GRUMPKIN_HONK_SUMCHECK_SIZE_17_PUB_24_circuit(
            ...
            let mut scalars: Span<u384> = array![
                ...
                scalar_56, transcript.shplonk_z.into(), scalar_68,
            ]
                .span();
